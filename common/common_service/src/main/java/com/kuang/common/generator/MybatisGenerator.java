package com.kuang.common.generator;
...
public class MybatisGenerator {
    ...
    public void genCode() {
        ...
        String database = "likeever_member";
...
//        gc.setFileOverride(false); //重新生成时文件是否覆盖
        ...
        //设置BaseEntity
        strategy.setSuperEntityClass("com.kuang.common.entity.mybatis.BaseEntity");
        // 填写BaseEntity中的公共字段
